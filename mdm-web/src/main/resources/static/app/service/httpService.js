...
//    if(url.indexOf("/mdm/module") ==-1 && url.indexOf("/mdm/invokeSystem") ==-1 && url.indexOf("/mdm/global") == -1
//    		&& url.indexOf("/mdm/invokeSystem/systemInfos") ==-1
//    		&& url.indexOf("/mdm/staticdata") == -1 && url.indexOf("/mdm/tree") ==-1 && url.indexOf("/mdm/loginCheck") ==-1 ){//非这些API场合从后端获取授权sign
//    
//		$http({
//		      method: "POST",
