angular.module('invokeSystem')
  .controller('ServiceInfoCrl', function ($scope, $modal, httpService, $rootScope) {
    ...
    $scope.querySystemNames = function () {
        httpService.req("GET","/mdm/invokeSystem/querySystemNameList", {}, function (result) {
      ...
      $scope.getSysNamesByService = function (index) {
          ...
          httpService.req("GET","/mdm/invokeSystem/getSysNamesByServiceCode",param, function (result) {
            var data = result.data;
            if (data != null) {
               $scope.sysNames=data;              
    ...
    $scope.queryServiceInfoList = function () {
      httpService.req("GET","/mdm/invokeSystem/serviceInfo", $scope.queryParams, function (result) {
        var data = result.data;
        if (data != null) {
...
//        	return;
//        }
        httpService.req("POST","/mdm/invokeSystem/serviceInfo",{},function (res) {
          if (res.data == 1) {
...
//		        	return;
//		      }
		      httpService.req("PUT","/mdm/invokeSystem/serviceInfo/"+$scope.editParams.id, {}, function (res) {
    ...
    $scope.doDel = function (index) {
        ...
        layer.confirm('确认要删除当前接口吗？', {
    	    ...
    	    title:"确认"
		      ...
		      httpService.req("PUT","/mdm/invokeSystem/deleteServiceInfo/"+$scope.delParams.id,{},function (res) {
	          if (res.data == 1) {
	        	 $rootScope.addAlert("success", "操作成功!");
		         $scope.queryServiceInfoList();
	          }
...
//  				pageSize : 100000
//    	  }
//    	  httpService.req("GET","/mdm/invokeSystem/checkExistParams", Params, function (result) {
