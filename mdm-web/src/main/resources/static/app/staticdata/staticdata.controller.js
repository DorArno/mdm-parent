angular.module('staticdata')
  .controller('StaticdataCrl', function ($scope, $modal, httpService, $rootScope) {
    ...
    $scope.queryStaticdataList = function () {
        httpService.req("GET","/mdm/staticdata/staticdatas", $scope.queryParams, function (result) {
    ...
    $scope.addConfirm = function () {
        ...
        httpService.req("POST","/mdm/staticdata/staticdata",{},function (res) {
          if (res.data == 1) {
    ...
    $scope.editConfirm = function () {
    	...
    	layer.confirm('确认要提交？', {
    	    ...
    	    title:"确认"
		      ...
		      httpService.req("PUT","/mdm/staticdata/updateStaticdata/"+$scope.editParams.id, {}, function (res) {
    ...
    $scope.doDel = function (index) {
        ...
        layer.confirm('确认要删除当前商家吗？', {
    	    ...
    	    title:"确认"
		      ...
		      httpService.req("PUT","/mdm/staticdata/deleteStaticdata/"+$scope.delParams.id,{},function (res) {
	          if (res.data == 1) {
	        	 $rootScope.addAlert("success", "操作成功!");
		         $scope.queryStaticdataList();
	          }
