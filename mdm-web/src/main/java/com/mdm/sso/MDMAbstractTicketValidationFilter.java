 ...
 * @since 3.1
 */
public abstract class MDMAbstractTicketValidationFilter extends AbstractCasFilter {
    ...
    public static final ConcurrentHashSet<String> conCurrentSkipListSet = new ConcurrentHashSet<String>();
   ...
   // public static final CopyOnWriteArrayList<String> copyOnWriteArrayList = new CopyOnWriteArrayList<String>();
        ...
        if (CommonUtils.isNotBlank(ticket)) {
            ...
            try {
               ...
               // if(copyOnWriteArrayList.size() > MAX_SIZE){
	    		...
	    		//}
	    	//	copyOnWriteArrayList.add(ticket);
                if (this.useSession) {
